...
public class KlientPersonListe {
	...
	public static void main(String[] args) {
		...
		/*
		 * Lineær søking i en sortert tabell * / Lineærsøking som returnerer sann eller
		 * usann
		 */
		...
		/*
		 * TODO Ikke-rekursiv binærsøking som returnerer indeksen, -1 ved ikke-funn
		 */
		 ...
		 * );
		 *
		 * ind = SoekingOgSortering.binaerSoek4(personerS, 0, personerS.length - 1,
		 * person1);
		 *
